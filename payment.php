...
if (isset($_GET['eml'])) {
	...
	$sql2 = "SELECT Card_name,RIGHT(Card_num,4)AS'nun',Card_edate FROM card WHERE Card_name = (SELECT Customer_name FROM customer WHERE Customer_ID = '$emml')";
		...
		<form class="form" method="post">
			<div class="card-info">
				...
				<div class="input_container">
					...
					<input class="input_field" type="text" name="name" readonly value="<?php echo $row2['Customer_name'] ?>" required>
				</div>
				<div class="input_container">
	...
	<div class="modal" <?php echo $pop ?>>
		<form class="form" method="post">
			<div class="card-info">
				...
				<div class="input_container">
					<label class="input_label">Card holder name</label>
					<input readonly class="input_field" type="text" name="name" value="<?php echo $row2['Card_name'] ?>" required>
				</div>
				<div class="input_container">
					<label class="input_label">Card Number</label>
...
if(isset($_POST['save'])) {
	...
	if (mysqli_query($connect, $sql))
	{
		...
		echo 'window.location.href = "checkout.php?eml='. $emml . '&tt='. $total . '&pm=Card";';
