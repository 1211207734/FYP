...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["id"]) && isset($_POST["action"])) {
        ...
        if ($action === "activate" || $action === "inactivate") {
            ...
            $sql = ($action === "activate")
                ? "UPDATE promotion SET status = 'active' WHERE code_id = ?"
                : "UPDATE promotion SET status = 'inactive' WHERE code_id = ?";
            ...
            // Perform the SQL update operation based on the action
            $sql = "UPDATE promotion SET status = 'delete' WHERE code_id = ?";
