...
<head>
  <title>JBP online Gadgets Shop</title>
  <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row align-items-center w-100">
        <div class="col-8 col-md-3">
          <a class="navbar-brand" href="index.html"  width="204" height="46" alt="logo"><b>JBP</b>store</a>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="orderhistory.php?eml=<?php echo $emml?>">Order History</a>
                </li>
                <li class="nav-item">
                  <script>
                    sessionStorage.setItem('userc',);
                </script>
    ...
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-10">
          ...
          <h2 class="fs-2 text-center">We're constantly testing new products, researching recent trends in the tech space, and updating our list of cool gadgets accordingly.</h2>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="footer-menu footer-menu-001">
            ...
            <div class="social-links">
              <ul class="list-unstyled d-flex flex-wrap gap-3">
                <li>
                  <a href="https://www.facebook.com/profile.php?id=100067679114376" class="text-secondary">
                    <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#facebook"></use></svg>
                  </a>
                </li>
                <li>
                  <a href="https://instagram.com/jbpstore" class="text-secondary">
